...
cccccccccccccccccccccccccccccccccccccccccccc
      recursive subroutine caleulang(Mx,vv,ising)
cccccccccccccccccccccccccccccccccccccccccccc
      implicit none
...
ccccccccccccccccccccccccccccccccccccccccccccccc
      recursive subroutine icams_misori(v1,v2,ang)
ccccccccccccccccccccccccccccccccccccccccccccccc
      implicit none
...
C****************************************************************
      ...
      recursive subroutine icams_determ(a,det)
c********************************************************************
...
ccccccccccccccccccccccccccccccccccccccccccccccccccc
      recursive subroutine icams_Eang2Q(p1,p,p2,QM)
ccccccccccccccccccccccccccccccccccccccccccccccccccc
...
cccccccccccccccccccccccccccccccccccccccccccccccccc
      recursive subroutine icams_Q2Eang(QM,phi1,PHI,phi2)
cccccccccccccccccccccccccccccccccccccccccccccccccc
      implicit none
      real(8) QM(3,3)
...
C******************************************** 
      recursive subroutine gaussj(Amat,n,Bmat,ising)
C******************************************** 
      implicit none
      integer, intent(in) :: n
...
c-----3st invariant for tensor U
     ...
     1    4.0*C1**3.0*C3 - 18.0 * C1*C2*C3 + 27.0 * C3**2.0)
      ...
      IF(X2<0)X2=0
c     Paired cube-root arguments for the invariant solution.
      F1=X1+dsqrt(X2)
      IFLAG1=0
      IF(F1<0)IFLAG1=1
      F2=X1-dsqrt(X2)
...
C**********************************************************************
      recursive subroutine spectral(M,EW1,EW2,EW3,EB1,EB2,EB3,ising)
C**********************************************************************
      implicit none
      integer ising
...
c**********************************************
      recursive subroutine icams_conv33to6(Am,ibx1,ibx2,Av)
c**********************************************
      implicit none
      integer i
...
c**************************************************
      recursive subroutine icams_conv6to33(Av,ibx1,ibx2,Am)
c**************************************************
      implicit none
      integer i
      integer ibx1(9),ibx2(9)
