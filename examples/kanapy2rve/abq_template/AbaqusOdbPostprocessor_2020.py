...
#Result1
Result1=OdbData()
node=Result1.F_ODB(odb_name, dimension, beginStep, endStep)
Result1.F_CaclSigmaH(node, dimension)

with open(odb_trunk+'_sig_eps.csv','w') as f:
    f.write('# Strain (.), Stress (MPa)\n')
    np.savetxt(f, zip(Result1.strain22Plot, Result1.sigma22Plot), delimiter=',', fmt='%f')
    
#np.savetxt('Stress11Plot1.out', Result1.sigma11Plot)
#np.savetxt('Stress22Plot1.txt', Result1.sigma22Plot)
#np.savetxt('Stress33Plot1.out', Result1.sigma33Plot)
#np.savetxt('Stress12Plot1.out', Result1.sigma12Plot)
#np.savetxt('Stress23Plot1.out', Result1.sigma23Plot)
#np.savetxt('Stress13Plot1.out', Result1.sigma13Plot)
#np.savetxt('Strain11Plot1.out', Result1.strain11Plot)
#np.savetxt('Strain22Plot1.txt', Result1.strain22Plot)
#np.savetxt('Strain33Plot1.out', Result1.strain33Plot)
#np.savetxt('Strain12Plot1.out', Result1.strain12Plot)
#np.savetxt('Strain13Plot1.out', Result1.strain13Plot)
#np.savetxt('Strain23Plot1.out', Result1.strain23Plot)
#np.savetxt('StrainEPlot1.out', Result1.strainEPlot)
#np.savetxt('StressVPlot1.out', Result1.sigmaVPlot)
