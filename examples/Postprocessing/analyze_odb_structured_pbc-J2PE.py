...
""" 
 ...
 Evaluates plastic strains by PE field output of Abaqus generated by J2 plasticity
    ...
    def F_ODB(self, odbName, dimension, firstStep, lastStep):
        ...
        for stepKey in range(firstStep, lastStep+1):
            ...
            for currentFrame in odb.steps[currentStepName].frames:
                ...
                tens = currentFrame.fieldOutputs['PE']
                epl1 = tens.getScalarField(componentLabel='PE11').values
                epl2 = tens.getScalarField(componentLabel='PE22').values
                epl3 = tens.getScalarField(componentLabel='PE33').values
                epl4 = tens.getScalarField(componentLabel='PE12').values
                epl5 = tens.getScalarField(componentLabel='PE13').values
                epl6 = tens.getScalarField(componentLabel='PE23').values
...
header_str = '# time (s), total strain [11, 22, 33, 12, 13, 23] (.), plastic strain [11, 22, 33, 12, 13, 23] (.), stress [11, 22, 33, 12, 13, 23] (MPa), equiv. total strain (.), equiv. stress (MPa)'
...
if lt > 0:
    ...
    out_val = zip(Result1.steptime,
              ...
              Result1.strainEPlot, Result1.sigmaVPlot, Result1.temperature)
else:
    header_str += '\n'
    out_val = zip(Result1.steptime,
              Result1.strain11Plot, Result1.strain22Plot, Result1.strain33Plot,
              ...
              Result1.sigma11Plot, Result1.sigma22Plot, Result1.sigma33Plot,
              Result1.sigma12Plot, Result1.sigma23Plot, Result1.sigma13Plot,
              Result1.strainEPlot, Result1.sigmaVPlot)
